...
```{r specify PP data, echo = FALSE, Fig_S2.1,fig.width=3, fig.height=3}
data <- alldata1
hist(data$chla)
hist(log(data$chla))
...
=======
```{r PP.plot2}
#tiff("Fig2A.tiff", units="in", width=3, height=3, res=600)

PP.plot2 <- ggplot(data = data, aes(x = -invTi, y = log(chla), ymin = 0, ymax = 3)) + #, xmin = -40.2, xmax = -38.2
>>>>>>> d6f172b2852ddcd18315f88a1cb22c02de9a3aca
  theme_bw() +
...
=======
  annotate("text", x = c(-39.75,-39.75,-39.75), y = c(.9, 0.6, 0.3), label = c("solid = Algae", "dotted = Algae + Grazer", "dashed = AG + Predator"), hjust = 0, size = 3) +
>>>>>>> d6f172b2852ddcd18315f88a1cb22c02de9a3aca
