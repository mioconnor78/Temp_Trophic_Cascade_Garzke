...
tiff(file = "Fig2A.tiff", width = 3, height = 3, units = "in", res = 300)
Fig2A
dev.off()
```
...
tiff(file = "Fig2.tiff", width = 8, height = 4, units = "in", res = 300, pointsize = 6)
Fig2MT
dev.off()
```
...
tiff(file = "Fig5.tiff", width = 8, height = 4, units = "in", res = 300, pointsize = 6)
Fig5MT
dev.off()
```
...
```{r}
tiff(file = "Fig3.tiff", units = "in", width=5, height = 5, res = 300)
